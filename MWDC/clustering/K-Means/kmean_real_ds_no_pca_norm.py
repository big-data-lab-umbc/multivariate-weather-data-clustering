# -*- coding: utf-8 -*-
"""KMean_Real_DS_No_PCA_Norm.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bzCd3fvEufbcGfAidydF0WOeCQdziSlv
"""
...
df1.to_csv("/content/drive/MyDrive/Private/Image_Similarity/kmeans_Daily_Norm.csv")
df1
...
trans_data.to_csv("/content/drive/MyDrive/Private/Image_Similarity/Kmean7cl_trans_data_daily_Norm.csv")
...
def silhouette_score1(X, labels, pass_trans_data = True, *, metric="euclidean", sample_size=None, random_state=None, **kwds):
   if pass_trans_data == True:
          ...
          path = ("/content/drive/MyDrive/Private/Image_Similarity/Kmean7cl_trans_data_daily_Norm.csv")
