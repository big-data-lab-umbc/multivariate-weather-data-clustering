...
def st_rmse(input_path, variables,formed_clusters, transformation=True):
  ...
  if transformation==True:
    ...
    trans_data = data_preprocessing(input_path, variables)
    ...
    if transformation==False:
      input_path['Cluster'] = formed_clusters
...
def st_corr(input_path, variables,formed_clusters, transformation=True):
...
# path = ('/content/multivariate-weather-data-clustering/data/ERA5_meteo_sfc_2021_daily.nc')

# st_rmse(path, var,formed_clusters, transformation=True)
# st_corr(path, var,formed_clusters, transformation=True)
# st_calinski(path, var,formed_clusters, transformation=True)
# davies_bouldin(path, var,formed_clusters, transformation=True)
