...
def main():
    ...
    save_dir = '/content/drive/MyDri......._Clustering/final/ensemble_alg/DSC_2/saved' # The trained model will be stored here
...
#sim_matrixx = geek.load('/content/drive......./final/ensemble_alg/Non-negative Matrix Factorization/DEC_co_occurrence_matrix.npy')
