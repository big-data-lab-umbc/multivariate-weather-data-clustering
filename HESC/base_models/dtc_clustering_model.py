...
class DTC:
    ...
    def pretrain(self, X,
                 ...
                 epochs=10,
                 batch_size=64,
                 save_dir='/content/drive/MyDrive..............final/ensemble_alg/DTC-Clustering-Model',
                 verbose=1):
        """
    ...
    def fit(self, X_train, y_train=None,
            ...
            save_dir='/content/drive/......./final/ensemble_alg/DTC-Clustering-Model'):
        """
        Training procedure
        # Arguments
...
data_path = ('/content/driv......._2021_daily.nc')
...
print(sim_matrixx)
np.save('/content/drive/......./final/ensemble_alg/DSC_ens_co_occurrence_matrix.npy', sim_matrixx)
...
#sim_matrixx = geek.load('/content/drive/.......Ensemble_Clustering/final/ensemble_alg/Non-negative Matrix Factorization/DEC_co_occurrence_matrix.npy')
...
# result = pickle.load(open("/content/......./Ensemble_Clustering/final/ensemble_alg/Final_ensemble/DSC_Ensemble1_032.pkl", "rb"))
...
# result = pickle.load(open("/content/.......Clustering/final/ensemble_alg/Final_ensemble/DTC_295.pkl", "rb"))
# result_1 = pickle.load(open("/content/......./final/ensemble_alg/Final_ensemble/DTC_295.pkl", "rb"))
# result_2 = pickle.load(open("/content/drive/......./final/ensemble_alg/Final_ensemble/DTC_3367.pkl", "rb"))
# result_3 = pickle.load(open("/content/drive/......./ensemble_alg/Final_ensemble/DTC_3124.pkl", "rb"))
# result_4 = pickle.load(open("/content/......./final/ensemble_alg/Final_ensemble/DTC_3226.pkl", "rb"))
# result_5 = pickle.load(open("/content/.......g/final/ensemble_alg/Final_ensemble/DTC_02014.pkl", "rb"))
...
print(sim_matrixx)
np.save('/content/drive/.......ensemble_alg/Non-negative Matrix Factorization/DTC_ens_co_occurrence_matrix.npy', sim_matrixx)
#print(norm_sim_matrix)
...
#sim_matrixx = geek.load('/content/drive/MyDriv......./final/ensemble_alg/Non-negative Matrix Factorization/DEC_co_occurrence_matrix.npy')
...
pickle.dump(final_labels, open("/content/drive/MyDrive......._Clustering/final/ensemble_alg/Final_ensemble/DTC_hom_ens_034.pkl", "wb"))

#cluster_result = pickle.load(open("/content/drive/MyDrive......./ensemble_alg/Final_ensemble/test_clustering_results30.pkl", "rb"))
...
df = pd.read_csv("/content/drive/MyDrive/ECRP_Data_Science/Implementation and Results......._Combination/PCA_Combined_var1.csv")
...
df1.to_csv("/content/drive/ /final/ensemble_alg/DEC_clustering.csv")
df1
...
pickle.dump(clusters, open("/content/drive/MyDrive......._Clustering/final/ensemble_alg/Final_ensemble/DSC_ensemble2_028.pkl", "wb"))

#cluster_result = pickle.load(open("/content......._Clustering/final/ensemble_alg/Final_ensemble/DSC_ensemble2_028.pkl", "rb"))
